...
class ADModeltest {
	...
	@Test
	void test() {
		Advertisement a = new Advertisement(300,"LOOK AT ME!! I AM COMPANYC",30);
		Advertisement b = new Advertisement(301,"LOOK AT ME!! I AM PersonD",10);
		a.createinrest();
		b.createinrest();
		assertEquals(a,a.readfromServer());
		a.setTime(26);
		a.updateinrest();
		assertEquals(a,a.readfromServer());
		ad = new ADModel(stage);
		ArrayList<Advertisement> li = new ArrayList<Advertisement>();
		li.add(a);
		li.add(b);
		assertArray(li,ad.getAll());
		Advertisement c = new Advertisement(302,"LOOK AT ME!! I AM PersonE",10);
		c.createinrest();
		ad.update();
		li.add(c);
		assertArray(li,ad.getAll());
